export function GetIconDataByName(name){
    let iconData=header_icons_svg[0];
    header_icons_svg.forEach((item,index)=>{
        if(name===item.name.en){
            iconData= item;
        }
    });
    return iconData;
...
export const header_icons_svg=[
    ...
    },
    {
        ...
        icon:
            <svg viewBox="0 0 64 68" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentcolor" strokeWidth="2.2"><circle cx="28" cy="28" r="20"/><line x1="56" y1="56" x2="42.14" y2="42.14"/>
                {/* <title>Пошук</title> */}
            </svg>,
    },
    {
    ...
    },
    {
        ...
        icon:
            <svg viewBox="-3.5 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                {/* <title>Зілогінитись</title> */}
                <path 
